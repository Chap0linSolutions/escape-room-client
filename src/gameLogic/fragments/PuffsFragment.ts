...
export class PuffsFragment extends Fragment {
  ...
  drawHitboxes(canvas: CanvasRenderingContext2D) {
    ...
    renderHitbox(
      canvas,
      this.getAbsoluteCoords(this.interactions.bluePuff.coordinate),
      this.interactions.bluePuff.radius
    );
    renderHitbox(
      canvas,
      this.getAbsoluteCoords(this.interactions.redPuff.coordinate),
      this.interactions.redPuff.radius
    );
    renderHitbox(
      canvas,
      this.getAbsoluteCoords(this.interactions.whiteBoard.coordinate),
      this.interactions.whiteBoard.radius
    );
  }
